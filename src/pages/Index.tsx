    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      ...
      <section className="py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <motion.p variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} custom={1} className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mb-16 leading-relaxed">
            En Creant, no solo creamos contenido; construimos puentes digitales. Combinamos la potencia del branding y la identidad visual de Milagros con la precisión estratégica en pauta y conversión de Juan. Con más de una década de experiencia sumada, nos enfocamos en que tu marca no solo se vea increíble, sino que también venda y conecte de forma auténtica.
          </motion.p>
      ...
      <footer className="py-8 border-t border-border text-center text-muted-foreground">
        <div className="flex items-center justify-center gap-6 mb-4">
          ...
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" aria-label="Escribinos por WhatsApp" className="hover:text-primary transition-colors">
            <MessageCircle className="h-5 w-5" aria-hidden="true" />
          </a>
        </div>
