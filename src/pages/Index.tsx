...
import { ArrowRight, BarChart3, PenTool, TrendingUp, Mail } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="text-2xl font-black tracking-tighter">
            CREANT<span className="text-primary">.</span>
          </div>
          <Button variant="outline" className="hidden md:flex rounded-full border-white/10 hover:bg-white/5">
            Hablemos
          </Button>
        </div>
      </nav>
      ...
      <section className="pt-40 pb-20 md:pt-52 md:pb-32 px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="rounded-full text-lg h-14 px-8 font-bold">
      ...
      <section className="py-24 bg-secondary/30 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-background p-10 rounded-3xl border border-white/5 hover:border-primary/50 transition-colors group">
            ...
            <div className="bg-background p-10 rounded-3xl border border-white/5 hover:border-primary/50 transition-colors group">
              <div className="h-16 w-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-primary transition-colors">
                <TrendingUp className="h-8 w-8 text-primary group-hover:text-primary-foreground" />
              </div>
          ...
          <div className="max-w-md mx-auto space-y-4">
            <div className="space-y-4">
              <input 
                ...
                className="w-full h-14 bg-secondary/50 border border-white/10 rounded-xl px-6 outline-none focus:border-primary transition-colors"
              />
              <input 
                type="email" 
              ...
              <textarea 
                ...
                className="w-full h-32 bg-secondary/50 border border-white/10 rounded-xl px-6 py-4 outline-none focus:border-primary transition-colors resize-none"
              />
            </div>
      ...
      <footer className="py-8 border-t border-white/5 text-center text-muted-foreground">
        <p>© {new Date().getFullYear()} Creant Studio. Todos los derechos reservados.</p>
      </footer>
    </div>
  );
};
