...
const CASOS: Caso[] = [
  ...
  },
  {
    ...
    resultado: "628 mil se quedaron mirando",
    queSignifica: "Cada una costó cincuenta y dos centavos. Y 7 de cada 10 de las que se quedaron llegaron hasta el final del video.",
    grafico: { tipo: "puntos", llenos: 70, leyenda: "de cada 100 que se quedaron mirando, llegaron al final" },
  },
  {
